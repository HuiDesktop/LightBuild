...
public:
    ...
    */
    LAppSprite(float x, float y, float width, float height, unsigned int textureId, unsigned int programId);
    ...
    *
    */
    void RenderImmidiate(unsigned int textureId, const float uvVertex[8]) const;
